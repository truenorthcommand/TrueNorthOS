...
CREATE TABLE "deductions" (
	...
	"applied_to_payroll" boolean DEFAULT false NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "intelligence_conversations" (
	"id" varchar PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"conversation_id" varchar NOT NULL,
	"user_id" varchar NOT NULL,
	"client_id" varchar,
	"property_id" varchar,
	"query_scope" text DEFAULT 'property' NOT NULL,
	"user_query" text NOT NULL,
	"ai_response" text NOT NULL,
	"response_type" text DEFAULT 'factual' NOT NULL,
...
CREATE TABLE "material_profiles" (
	...
	"permitted_materials" jsonb DEFAULT '[]'::jsonb NOT NULL,
	"flagged_materials" jsonb DEFAULT '[]'::jsonb NOT NULL,
	"is_active" boolean DEFAULT true NOT NULL,
	"created_by_id" varchar,
	"created_at" timestamp DEFAULT now(),
	"updated_at" timestamp DEFAULT now()
...
CREATE TABLE "vendor_rules" (
	...
	"permitted_items" jsonb DEFAULT '[]'::jsonb NOT NULL,
