...
export function GlobalAIAssistant() {
  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="fixed bottom-24 right-6 z-50 h-14 w-14 rounded-full bg-gradient-to-br from-purple-500 to-violet-600 text-white shadow-lg hover:shadow-xl transition-all hover:scale-105 flex items-center justify-center group"
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between px-4 py-3 bg-gradient-to-r from-purple-500 to-violet-600 rounded-t-2xl">
