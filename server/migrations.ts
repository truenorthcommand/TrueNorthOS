...
export async function runMigrations() {
  ...
  // Security fields and backup codes for closed-loop authentication
  try {
    ...
    `);
    console.log("[Migration] Existing users marked as migrated");

    // Remove Google OAuth column (no longer needed)
    await client.query(`
      ALTER TABLE users DROP COLUMN IF EXISTS google_id;
    `);
    console.log("[Migration] Google OAuth column removed");
    ...
    `);
    console.log("[Migration] Backup codes table created");
    ...
    `);
    console.log("[Migration] Security indexes created");

    // Add foreign key constraints for audit trail
    // Note: These may fail if constraints already exist, wrapped in individual tries
    try {
      await client.query(`
        ALTER TABLE users 
      ...
      if (!fkError.message.includes('already exists')) {
        console.error("[Migration] FK constraint fk_account_created_by error:", fkError.message);
      }
    }
    ...
    try {
      ...
      if (!fkError.message.includes('already exists')) {
        console.error("[Migration] FK constraint fk_last_password_reset_by error:", fkError.message);
      }
    }
    
    console.log("[Migration] Security foreign keys added");
  } catch (e: any) {
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // FLEET MANAGEMENT SYSTEM - Comprehensive Vehicle Tracking
  // ═══════════════════════════════════════════════════════════════════════════

  // Enhance existing vehicles table with additional tracking fields
  try {
    await client.query(`
    ...
    `);
    console.log("[Migration] vehicles table enhanced with fleet tracking fields");
  } catch (e: any) {
    console.error("[Migration] vehicles enhancement error:", e.message);
  }
  ...
  try {
    await client.query(`
      ...
      END $$;
    `);
    console.log("[Migration] vehicles registration unique constraint OK");
  } catch (e: any) {
    console.error("[Migration] vehicles unique constraint error:", e.message);
  }
  ...
  try {
    ...
    `);
    console.log("[Migration] vehicle_equipment table + indexes OK");
  } catch (e: any) {
    console.error("[Migration] vehicle_equipment error:", e.message);
  }
  ...
  try {
    ...
    `);
    console.log("[Migration] vehicle_assignments table + indexes OK");
  } catch (e: any) {
    console.error("[Migration] vehicle_assignments error:", e.message);
  }
  ...
  try {
    ...
    `);
    console.log("[Migration] mot_records table + indexes OK");
  } catch (e: any) {
    console.error("[Migration] mot_records error:", e.message);
  }
  ...
  try {
    ...
    `);
    console.log("[Migration] insurance_records table + indexes OK");
  } catch (e: any) {
    console.error("[Migration] insurance_records error:", e.message);
  }
  ...
  try {
    ...
    `);
    console.log("[Migration] road_tax_records table + indexes OK");
  } catch (e: any) {
    console.error("[Migration] road_tax_records error:", e.message);
  }
  ...
  try {
    ...
    `);
    console.log("[Migration] service_records table + indexes OK");
  } catch (e: any) {
    console.error("[Migration] service_records error:", e.message);
  }
  ...
  try {
    ...
    `);
    console.log("[Migration] fuel_records table + indexes OK");
  } catch (e: any) {
    console.error("[Migration] fuel_records error:", e.message);
  }
  ...
  try {
    ...
    `);
    console.log("[Migration] reminders table + indexes OK");
  } catch (e: any) {
    console.error("[Migration] reminders table error:", e.message);
  }

  // Create trigger function to update reminders.updated_at
  try {
    await client.query(`
    ...
    `);
    console.log("[Migration] reminders updated_at trigger OK");
  } catch (e: any) {
    console.error("[Migration] reminders trigger error:", e.message);
  }

  // Create automatic reminder creation function and triggers
  try {
    await client.query(`
      ...
      EXECUTE FUNCTION create_automatic_reminder();
    `);
    console.log("[Migration] automatic reminder triggers OK (4-week advance notification)");
  } catch (e: any) {
    console.error("[Migration] automatic reminder triggers error:", e.message);
  }
